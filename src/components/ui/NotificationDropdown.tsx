  ...
  const fetchLatestNotifications = async () => {
    try {
      ...
      const mockNotifications: Notification[] = [
        ...
        // Add more mock notifications to simulate the count issue
        {
          id: 4,
          senderRole: "TEACHER",
      ...
      setNotifications(sortedMockNotifications.slice(0, 3));
      setUnreadCount(notificationService.getUnreadCount(mockNotifications));
    } finally {
      setLoading(false);
    }
  };
