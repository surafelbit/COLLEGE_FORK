...
import { GraduationCap, User, LayoutDashboard, BarChart3, Settings, Users, LogOut, Star, Layers, Menu, StarHalf, CircleStar, } from "lucide-react";
...
export default function ManagerLayout() {
    ...
    return (_jsxs("div", { className: "flex min-h-screen bg-gray-50 dark:bg-gray-900", children: [sidebarOpen && (_jsx("div", { className: "fixed inset-0 z-40 bg-gray-600 bg-transparent lg:hidden", onClick: () => setSidebarOpen(false) })), _jsxs("div", { className: `fixed flex flex-col inset-y-0 left-0 z-50 w-64
