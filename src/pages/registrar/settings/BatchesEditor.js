...
const BatchesEditor = () => {
    ...
    return (_jsxs("div", { className: "min-h-screen p-6 transition-colors duration-300 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100", children: [_jsx("header", { className: "mb-10", children: _jsx("div", { className: "flex flex-col sm:flex-row justify-between items-center mb-6", children: _jsx("h1", { className: "text-4xl font-extrabold bg-blue-500 bg-clip-text text-transparent", children: "DHFM Batches Editor" }) }) }), _jsx("main", { children: _jsx(CrudSection, { title: "Batches", data: batches, setData: setBatches }) })] }));
};
