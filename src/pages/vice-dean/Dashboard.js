...
export default function DeanDashboard() {
    return (_jsx("div", { className: "min-h-screen bg-white dark:bg-gray-900", children: _jsxs("div", { className: "p-6 space-y-6 max-w-7xl mx-auto", children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("h1", { className: "text-3xl font-bold text-blue-600 dark:text-blue-400", children: "Dean Dashboard" }), _jsx(Link, { to: "/dean/create-department-head", children: _jsxs(Button, { className: "flex items-center gap-2 bg-blue-600 hover:bg-blue-700", children: [_jsx(UserPlus, { className: "h-4 w-4" }), "Create Department Head"] }) })] }), _jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4", children: [
